...
# input of language name and language field
user_language_reply = input()
user_language = user_language_reply.lower()
user_field = input()  # input variants: [phonetics, syntax, lexicon, noun_morphology, verb_morphology]

# getting codes of languages -- here we need
...
if user_language in languages_info.values:
    ...
    user_code = str()
    print(f'Unfortunately, {user_language_reply} is not found in WALS database')
...
chapter_types["noun_morphology"] = ["20A", "21A", "22A", "23A", "24A", "25A", "26A", "27A", "28A",
                                    "29A", "30A", "31A", "32A", "33A", "34A", "35A", "36A", "37A", "38A",
                                    "39A", "40A", "41A", "42A", "43A", "44A", "45A", "46A", "47A",
                                    "48A", "49A", "50A", "51A", "52A", "53A", "54A", "55A", "56A", "57A"]
chapter_types["verb_morphology"] = ["65A", "66A", "67A", "68A", "69A", "70A", "71A", "72A", "73A",
                                    "74A", "75A", "76A", "77A", "78A", "79A", "80A"]
chapter_types["syntax"] = ["58A", "59A", "60A", "61A", "62A", "63A", "64A", "81A", "82A", "83A", "84A", "85A", "86A",
...
file_chapters_values = pd.read_csv('https://raw.githubusercontent.com/cldf-datasets/wals/master/raw/domainelement.csv')
...
if len(user_output) != 0:
    for chapter in user_output.keys():
        descriptions[chapter] = chapters_values.loc[chapters_values["id"] == chapter + "-" + str(user_output[chapter]),
                               "description"].iloc[0]
