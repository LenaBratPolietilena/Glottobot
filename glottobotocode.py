...
class Language:
    ...
    def glottolog_extract(self):
        ...
        return glottolog.glottolog_info(self.name) + f'\n\nIf you would like to learn more about phological inventory of {self.name}, click on the Phonological Inventory Description button'
